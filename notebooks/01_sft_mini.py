...
#
# `bkai-foundation-models/vi-alpaca` is a 50k-row VN Alpaca translation
# (`instruction/input/output`). Lab 21 uses 1k slice for the demo run; we match
# that exactly so reward gap is comparable.
